...
const priceIncrease = computed(() => {
    return  Math.floor(team.boatInventory.length / 5) * game.boatPriceIncrease
})
  ...
  <div class="bg-violet-500">
    <div>
      <div class="flex justify-center flex-col items-center text-slate-200 m-5">
        ...
        <h2>I ejer lige nu {{ team.boatInventory.length }} både jeres priser stiger derfor med {{ priceIncrease.toLocaleString('da-DK') }} VM$</h2>
      </div>
